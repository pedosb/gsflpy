...
Lembrando que é conhecido o modelo (HMM's) onde cada uma das quinze sentenças se encontra frame-a-frame.
 ...
 \item Uma região de confusão não pode se repetir dentro de uma lattice. Esse fato acontence muito na segunda base de dados, onde duas concorrentes, quando
