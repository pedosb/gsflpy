...
Exemplo numérico: Cada linha da matriz $H$ abaixo representa uma das
...
Lembrando que é conhecido o modelo (HMM's) onde cada uma das quinze sentenças se encontra frame-a-frame.
 ...
 \item Uma região de confusão não pode se repetir. Esse fato acontece muito na segunda base de dados, onde duas concorrentes, quando
